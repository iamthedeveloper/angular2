...
@Component({
  ...
  entryComponents: [HourlyComponent,
    ThreeDayForecastComponent, TendayHourlyComponent, 
    YesterdayComponent, TenDayForecastComponent], // Reference to the components must be here in order to dynamically create them
  template: `
